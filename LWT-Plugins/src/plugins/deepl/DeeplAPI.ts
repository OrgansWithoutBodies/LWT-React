...
import type { DeeplOpenAPI } from "lwt-schemas/openapi";
import {
  AxiosOpenAPIWrapper,
  BaseOpenAPIWrapper,
} from "../../BaseOpenAPIWrapper";

type DeeplComponents = DeeplOpenAPI.components;
type DeeplPaths = DeeplOpenAPI.paths;
