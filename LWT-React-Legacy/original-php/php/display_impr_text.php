...
if (isset($_REQUEST['text'])) {
	...
	if ($mobile) {
		...
		<div id="frame-h">
			<iframe id="frame-h-2" src="display_impr_text_header.php?text=<?php echo $_REQUEST['text']; ?>" scrolling="yes"
				name="header"></iframe>
		</div>
		<div id="frame-l">
			<iframe id="frame-l-2" src="display_impr_text_text.php?text=<?php echo $_REQUEST['text']; ?>" scrolling="yes"
				name="text"></iframe>
		</div>
	...
	<?php
		...
		<frameset
			rows="<?php echo (isset($audio) ? getSettingWithDefault('set-text-h-frameheight-with-audio') - 90 : getSettingWithDefault('set-text-h-frameheight-no-audio') - 90); ?>,*">
