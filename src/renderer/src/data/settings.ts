...
export type Settings = typeof SettingsObjValidator.TYPE;
...
type Test = MinMaxOfDefaultSetting<'set-texts-per-page'>;
const test = NumericalSettingInRangeValidator('set-test-r-frameheight-percent');
