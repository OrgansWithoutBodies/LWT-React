...
export function GetMultipleTagsActionsSelectOptions() {
  return (
    <GetGenericSelectOptions
      ...
      selectOptions={[
        { title: "[Choose...]", value: "" },
        { value: "del", title: "Delete Marked Tags" },
      ]}
    />
  );
}
...
export function GetAllTagsActionsSelectOptions() {
  return (
    <GetGenericSelectOptions
      ...
      selectOptions={[
        { title: "[Choose...]", value: "" },
        { value: "delall", title: "Delete ALL Tags" },
      ]}
    />
  );
}

export enum MultipleTextActionSelectOption {
  addtag = "addtag",
  deltag = "deltag",
  unarch = "unarch",
  del = "del",
...
export function MarkedTextsSelectOptions() {
  return (
    <>
      <option value="" />
...
export function GetMultipleWordsSelectoptions() {
  return (
    <>
      <option value="\" selected>
        [Choose...]
...
export function getMobileDisplayModeSelectoptions(v: 0 | 1 | 2) {
  return (
    <>
      <option value="0" selected={v === 0}>
        Auto
      </option>
      <option value="1" selected={v === 1}>
        Force Non-Mobile
      </option>
      <option value="2" selected={v === 2}>
        Force Mobile
      </option>
    </>
  );
