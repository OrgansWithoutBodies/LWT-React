...
function makeStatusClassFilterHelper(status: number, array: number[]) {
  const pos = array.indexOf(status);
  if (pos !== -1) {
    array[pos] = -1;
  }
}
...
// TODO
// Error: Term in lowercase must be exactly {...} please go back and correct this!

/**
 * @deprecated
 *
 * @param count - how many items
 * @TODO this pattern conflicts w i18n
 */
